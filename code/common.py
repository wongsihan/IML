...
class Optimizer:
    ...
    def setup_argparse(cls, parser, **kw):
        ...
        p.add_argument(
            ...
            # default=kw.get('directory', '/Users/envy/Documents/GitHub/SPINN/code/save'),
            default=kw.get('directory', 'D:\Github\SPINN\SPINN\code\save'),
    ...
    def solve(self):
        ...
        for i in range(1, n_train+1):
            ...
            if i % n_skip == 0 or i == n_train or iterations_done:
                ...
                print("After 1000 iters torque is :", torque)
...
class App:
    ...
    def run(self, args=None, **kw):
        ...
        # if os.path.exists('/Users/envy/Documents/GitHub/SPINN/code/save/model.pt'):
        #     nn = torch.load('/Users/envy/Documents/GitHub/SPINN/code/save/model.pt')
        self.nn = nn
